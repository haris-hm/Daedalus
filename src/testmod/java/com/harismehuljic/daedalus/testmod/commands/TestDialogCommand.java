package com.harismehuljic.daedalus.testmod.commands;
...
import com.harismehuljic.daedalus.testmod.dialog.WelcomeDialog;
...
public class TestDialogCommand {
    public static void register(CommandDispatcher<ServerCommandSource> dispatcher, CommandRegistryAccess registryAccess,
        ...
        final LiteralCommandNode<ServerCommandSource> testCommand = dispatcher.register(literal("daedalus-test")
                .then(literal("test_builder")
